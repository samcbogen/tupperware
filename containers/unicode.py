...
class NormalizedStr:
    ...
    The two strings to
    the right of the in keyword above are equal *semantically*,
    ...
    def __repr__(self):
        '''
        The string returned
        by the __repr__ function should be valid python code
    ...
    def __str__(self):
        ...
        NormalizedStr into a regular string object.
        The output
        is similar, but not exactly the same, as the __repr__ function.
        '''
    ...
    def __add__(self, b):
        ...
        HINT:
        The addition of two normalized
        strings is not guaranteed to stay normalized.
        Therefore, you must renormalize
    ...
    def __iter__(self):
        '''
        HINT:
        Recall that the __iter__ method
        returns a class, which is the iterator object.
