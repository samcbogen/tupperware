...
considerably harder than the functions in the BinaryTree file.
'''
...
class BST(BinaryTree):
    ...
    That means that the BST
    class "inherits" all of the methods from BinaryTree,
    ...
    def is_bst_satisfied(self):
        ...
        to automatically test whether insert/delete functions
    ...
    def _is_bst_satisfied(node):
        ...
        it only checks if the children
        of the current node are less than/greater than,
        rather than ensuring
        that all nodes to the left/right are less than/greater than.
        HINT:
        Use the _find_smallest
        and _find_largest functions to fix the bug.
        You should use the _ prefixed
        methods because those are static methods just like this one.
        '''
        ret = True
        if node.left:
    ...
    def insert_list(self, xs):
        ...
        You cannot get this method to
        work correctly until you have gotten insert to work correctly.
        '''
        for x in xs:
            self.insert(x)
    ...
    def _find_smallest(node):
        ...
        find_smallest and not intended to be called directly by the user.
        '''
    ...
    def remove(self, value):
        ...
        HINT:
        You should have
        everything else working before you implement this function.
        HINT:
